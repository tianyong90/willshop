  ...
  <div class="main-container main-with-padding">
    <div class="table-tools">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-button type="primary" icon="el-icon-plus" @click="search">新建分类</el-button>
      </el-form>
    </div>

    <el-table :data="categories.data" border>
      ...
      <el-table-column prop="product_count" label="商品数"></el-table-column>
